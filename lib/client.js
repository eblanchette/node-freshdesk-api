...
class Freshdesk {
	...
	listAllSatisfactionRatings(params, cb) {
		makeRequest(
			"GET",
			this._auth,
			`${this.baseUrl}/api/v2/surveys/satisfaction_ratings`,
			params,
			null,
			cb
		);
	...
	listAllTicketSatisfactionRatings(id, cb) {
		makeRequest(
			"GET",
			this._auth,
			`${this.baseUrl}/api/v2/tickets/${id}/satisfaction_ratings`,
			null,
			null,
			cb
		);
